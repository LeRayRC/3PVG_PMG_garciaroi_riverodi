...
VkPipeline PipelineBuilder::BuildPipeline(VkDevice device)
{
    ...
    _vertex_input_info.vertexBindingDescriptionCount = 1;
    _vertex_input_info.vertexAttributeDescriptionCount = static_cast<uint32_t>(attributeDescriptions.size());
    _vertex_input_info.pVertexBindingDescriptions = &bindingDescription;
    _vertex_input_info.pVertexAttributeDescriptions = attributeDescriptions.data();
