#ifndef __LAVA_DIFFUSE_RENDER_SYSTEM_H__
#define __LAVA_DIFFUSE_RENDER_SYSTEM_H__ 1

#include "lava/ecs/lava_ecs_components.hpp"


class LavaDiffuseRenderSystem
{
public:
	LavaDiffuseRenderSystem(class LavaEngine& engine);
	~LavaDiffuseRenderSystem();
